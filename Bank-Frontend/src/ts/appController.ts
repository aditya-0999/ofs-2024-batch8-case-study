...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      ...
      { path: "login", detail: { label: "Login", iconClass: "oj-ux-ico-profile-card" } },
      { path: "register", detail: { label: "Register", iconClass: "oj-ux-ico-contact-plus" } },
      { path: "customerDetails", detail: { label: "Customer Details", iconClass: "oj-ux-ico-contact-plus" } }
    ];
    // router setup
